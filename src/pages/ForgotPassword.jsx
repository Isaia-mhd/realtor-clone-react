      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <div className='my-3 w-full flex justify-between  text-sm sm:text-lg'>
            ...
            <div className='w-full bg-blue-600 rounded px-7 py-3 text-center text-white text-sm font-medium transition duration-150 ease-in-out hover:bg-blue-700 active:bg-blue-800'>
              <button type="submit" className='uppercase font-semibold'>Send reset password</button>
            </div>
